...
namespace Server
{
    ...
    public class Item : IEntity, IHued, IComparable<Item>, ISerializable, ISpawnable
    {
        ...
        public bool HasRuneword { get; set; } = false;
        ...
        public virtual void Serialize(GenericWriter writer)
        {
            ...
            //16
            writer.Write(RuneWordName);

            //15
            writer.Write(HasRuneword);
        ...
        public virtual void Deserialize(GenericReader reader)
        {
            ...
            {
                case 16:
                    RuneWordName = reader.ReadString();
                    goto case 15;
                case 15:
                    HasRuneword = reader.ReadBool();
                    goto case 14;
                case 14:
