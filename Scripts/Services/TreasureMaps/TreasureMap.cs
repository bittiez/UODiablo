...
namespace Server.Items
{
    public class TreasureMap : MapItem
    {
        ...
        private static Type[][] m_SpawnTypes = new Type[][]
        {
            ...
            new Type[]{ typeof( Banished ), typeof( OgreLord ), typeof( DreadSpider ), typeof( AirElemental ), typeof( FireElemental ) },
        ...
        private static Type[][] m_TokunoSpawnTypes = new Type[][]
        {
            ...
            new Type[]{ typeof( AirElemental ), typeof( DreadSpider ), typeof( FireElemental ), typeof( Banished ), typeof( OgreLord ), },
