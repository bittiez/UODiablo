    ...
    public class HelpGump : Gump
    {
            ...
            : base(0, 0)
        {
            ...
            if (isYoung)
            {
                ...
                this.AddHtml(110, 75, 450, 58, @"<BODY><BASEFONT COLOR=BLACK><u>Young Player Haven Transport.</u> Select this option if you want to be transported to the Rogue Encampment.</BODY>", true, true);
                ...
                case 9: // Young player transport
                    {
                        if (IsYoung(from))
                        {
                            ...
                            {
                                from.MoveToWorld(new Point3D(1500, 2204, 3), Map.Normal);
                            }
                        }
