using System;
using Server.Custom.Mobiles.Champs;
    ...
    public class ChampionSpawnInfo
    {
        ...
        private static readonly ChampionSpawnInfo[] m_Table = new ChampionSpawnInfo[]
        {
            ...
            { // Unholy Terror
                ...
                new Type[] { typeof(BoneKnight), typeof(Banished), typeof(SkeletalKnight) }, // Level 3
            ...
            new ChampionSpawnInfo("Andarial", typeof(Andarial), new string[]{ "Banisher", "Enforcer", "Eradicator" }, new Type[][]
            {
                new Type[] { typeof(DarkHunter) },
                new Type[] { typeof(DarkHunter), typeof(DarkArcher) },
                new Type[] { typeof(DarkHunter), typeof(DarkArcher), typeof(DarkSpear) },
                new Type[] { typeof(DarkHunter), typeof(DarkArcher), typeof(DarkSpear) },
            }),
        };
