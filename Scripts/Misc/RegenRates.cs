...
namespace Server.Misc
{
    ...
    public class RegenRates
    {
        ...
        public static double HitPointRegen(Mobile from)
        {
            ...
            if (from is PlayerMobile && FoodBuffManager.GetBuff(Food.FoodBuffType.HitsRegen, from as PlayerMobile, out var buff))
            {
                points += buff.Value;
            }
        ...
        public static double StamRegen(Mobile from)
        {
            ...
            if (from is PlayerMobile && FoodBuffManager.GetBuff(Food.FoodBuffType.StamRegen, from as PlayerMobile, out var buff))
            {
                points += buff.Value;
            }
        ...
        public static double ManaRegen(Mobile from)
        {
            ...
            if (from is PlayerMobile && FoodBuffManager.GetBuff(Food.FoodBuffType.ManaRegen, from as PlayerMobile, out var buff))
            {
                points += buff.Value;
            }
