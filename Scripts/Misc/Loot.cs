        ...
        private static readonly Type[] m_MLResources =
{
        ...
        private static readonly Type[] m_PotionTypes = new[]
        {
            ...
            typeof(LesserHealPotion), typeof(LesserPoisonPotion), typeof(ManaPotion)
        };
        ...
        public static BasePotion RandomHealOrManaPot(int quantity = 1)
        {
            if (Utility.RandomBool())
            {
                return new HealPotion() { Amount = quantity };
            }
            else
            {
                return new ManaPotion() { Amount = quantity };
            }
        }
