...
namespace Server
{
    public class LootPack
    {
        ...
        public void ForceGenerate(Mobile from, Container cont)
        {
            if (cont == null)
            {
                return;
            ...
            for (int i = 0; i < m_Entries.Length; ++i)
            {
                ...
                Item item = entry.Construct(from, from.Luck, entry.AtSpawnTime);
        ...
        public static readonly LootPackItem[] AllRunes = new[] {
            new LootPackItem(typeof(Fe), 1),
            new LootPackItem(typeof(Ar), 1),
            new LootPackItem(typeof(Bjarka), 1),
            new LootPackItem(typeof(Hagal), 1),
            new LootPackItem(typeof(Is), 1),
            new LootPackItem(typeof(Kaun), 1),
            new LootPackItem(typeof(Logur), 1),
            new LootPackItem(typeof(Maoer), 1),
            new LootPackItem(typeof(Nauo), 1),
            new LootPackItem(typeof(Os), 1),
            new LootPackItem(typeof(Purs), 1),
            new LootPackItem(typeof(Reio), 1),
            new LootPackItem(typeof(Tyr), 1),
            new LootPackItem(typeof(Sol), 1),
            new LootPackItem(typeof(Ur), 1),
            new LootPackItem(typeof(Yr), 1)
        };
        ...
        #region UODiablo definitions
        public static readonly LootPack UOD_Gold3to15 = new LootPack(new LootPackEntry[]
        {
            new LootPackEntry(true, Gold, 100, "3d5")
        });

        public static readonly LootPack UOD_RuneBoard = new LootPack(new LootPackEntry[]
        {
            new LootPackEntry(true, new[] { new LootPackItem(typeof(RuneBoard), 1) }, 10, 1)
        });

        public static readonly LootPack UOD_HPManaPots = new LootPack(new LootPackEntry[]
        {
            new LootPackEntry(true, new[] { new LootPackItem(typeof(ManaPotion), 1), new LootPackItem(typeof(HealPotion), 1) }, 10, "1d2")
        });

        public static readonly LootPack UOD_ReagentTool = new LootPack(new LootPackEntry[]
        {
            new LootPackEntry(true, new[] { new LootPackItem(typeof(ReagentTool), 1) }, 10, 1)
        });

        public static readonly LootPack UOD_GearBag = new LootPack(new LootPackEntry[]
        {
            new LootPackEntry(true, new[] { new LootPackItem(typeof(GearBag), 1) }, 10, 1)
        });

        public static readonly LootPack UOD_AllRunesForBosses = new LootPack(new LootPackEntry[]
        {
            new LootPackEntry(true, AllRunes, 10, 1)
        });

        public static readonly LootPack UOD_BelowLvl12 = new LootPack(new LootPackEntry[]
        {
            new LootPackEntry(false, AosMagicItemsPoor, 1, 1, 5, 0, 100)
        });
        #endregion
    ...
    public class LootPackEntry
    {
        ...
        public bool AtSpawnTime => m_AtSpawnTime;
