...
namespace Server.Items
{
	...
	public class MoongateGump : Gump
	{
			...
			: base(100, 100)
		{
			...
			PMList[] checkLists = PMList.AllLists;

			m_Lists = new PMList[PMList.AllLists.Length];
			...
			{
                AddButton(10, 10 + (i * 25), 2117, 2445, 0, GumpButtonType.Page, Array.IndexOf(m_Lists, checkLists[i]) + 1);
                AddHtmlLocalized(14, 11 + (i * 25), 108, 20, checkLists[i].Number, false, false);
