...
namespace Server.Gumps
{
    ...
    public class ResurrectGump : Gump
    {
        ...
        public ResurrectGump(Action<Mobile> callback) : base(100, 0)
        {
            m_Msg = ResurrectMessage.Generic;
            ...
            AddHtml(50, 55, 300, 140, "Would you like to resurrect in town?", true, true);
            ...
            AddButton(65, 227, 4005, 4007, 499, GumpButtonType.Reply, 0);
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (info.ButtonID == 499 && pm != null)
            {
                BaseCreature.TeleportPets(from, pm.SpawnPoint, pm.SpawnMap, true);

                from.MoveToWorld(pm.SpawnPoint, pm.SpawnMap);
