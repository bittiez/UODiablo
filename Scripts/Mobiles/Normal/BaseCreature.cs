    ...
    public class BaseCreature : Mobile, IHonorTarget, IEngravable
    {
        ...
        public override int Str
        {
            get
            {
                if (IsUODMonster())
                {
                    return (int)(base.Str + (MonsterLevel * LevelStatModifier));
                }
        ...
        public bool IsUODMonster()
        {
            return !Controlled && !Summoned && !IsAnimatedDead && !IsNecroFamiliar && !(this is Clone) && !(this is BaseVendor);
        }
        ...
        */
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (!Controlled && !Summoned && !IsAnimatedDead && !IsNecroFamiliar && !(this is Clone) && !(this is BaseVendor))
            {
                list.Add($"Level {(MonsterLevel > 0 ? MonsterLevel.ToString() : "Unknown")}");
            }
        }
