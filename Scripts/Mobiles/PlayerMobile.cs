...
namespace Server.Mobiles
{
    ...
    public partial class PlayerMobile : Mobile, IHonorTarget
    {
		...
		*/
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public HashSet<int> WaypointsActivated { get; set; } = new HashSet<int>();

        public long NextTeleportUse { get; set; } = 0;

        public bool UseSummoningRite { get; set; }

        public Point3D SpawnPoint { get; set; } = new Point3D(1499, 2164, 3);
        public Map SpawnMap { get; set; } = Map.Normal;
        ...
        public override int HitsMax
        {
            get
            {
                ...
                if (FoodBuffManager.GetBuff(Food.FoodBuffType.MaxHP, this, out var buff))
                {
                    strOffs += (int)buff.Value;
                }

                return (int)(strBase / 1.75) + 50 + strOffs;
            }
        }
        ...
        public override int StamMax
        {
            get
            {
                ...
                if (FoodBuffManager.GetBuff(Food.FoodBuffType.MaxStamina, this, out var buff))
                {
                    bonus += (int)buff.Value;
                }

                return base.StamMax + AosAttributes.GetValue(this, AosAttribute.BonusStam) + bonus;
            }
        }
        ...
        public override int ManaMax
        {
            get
            {
                ...
                if (FoodBuffManager.GetBuff(Food.FoodBuffType.MaxMana, this, out var buff))
                {
                    bonus += (int)buff.Value;
                }
        ...
        public override void OnDeath(Container c)
        {
            ...
            new ResurrectGump(callback: null).SendTo(this.NetState);
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                ...
                case 41:
                    ...
                    for (int i = 0; i < c; i++)
                    {
                        WaypointsActivated.Add(reader.ReadInt());
                    }
                    goto case 40;
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            //41
            writer.Write(WaypointsActivated.Count);
            foreach (int i in WaypointsActivated)
            {
                writer.Write(i);
            }
        ...
        public bool CheckYoungProtection(Mobile from)
        {
            ...
            if (DateTime.UtcNow - m_LastYoungMessage > TimeSpan.FromMinutes(1.0))
            {
                ...
                SendMessage("A monster looks at you menacingly but decides not to attack.");
