...
namespace Server.Misc
{
    ...
    public class AccountHandler
    {
        ...
        //1075072 - 1075081 for towns
        private static readonly CityInfo[] UODiabloStarting = new CityInfo[]
        {
            new CityInfo("Rogue Encamptment", "Your Stash", 1075072, 980, 1650, 3, Map.Normal)
        };
