...
namespace Server.Commands
{
    public class DecorateDelete
    {
        ...
        private static void DecorateDelete_OnCommand(CommandEventArgs e)
        {
            ...
            Generate("Data/Decoration/AllDifficulties", Map.Normal, Map.Nightmare, Map.Hell);
            Generate("Data/Decoration/D1", Map.D1);
            Generate("Data/Decoration/Dungeons", Map.Dungeons);
