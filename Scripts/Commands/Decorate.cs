...
namespace Server.Commands
{
    public class Decorate
    {
        ...
        private static void Decorate_OnCommand(CommandEventArgs e)
        {
            ...
            Generate("deco", "Data/Decoration/AllDifficulties", Map.Normal, Map.Nightmare, Map.Hell);
            Generate("deco", "Data/Decoration/D1", Map.D1);
            Generate("deco", "Data/Decoration/Dungeons", Map.Dungeons);
